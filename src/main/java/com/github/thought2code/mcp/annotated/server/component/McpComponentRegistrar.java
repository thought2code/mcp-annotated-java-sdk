 ...
 * type of MCP component (such as tools, resources, or prompts) with an {@link McpSyncServer}. Each
 * implementation typically scans for methods annotated with the corresponding MCP annotation and
 * registers the discovered components accordingly.
 *
 * @see McpSyncServer
 * @author codeboyzhou
 */
